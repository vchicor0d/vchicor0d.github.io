...
\end{verbatim}
\captionof{figure}{\label{org8bb7809}
Hola Mundo}
...
\end{verbatim}
\captionof{figure}{\label{org877d9e3}
Aritmeticos}
...
\end{verbatim}
\captionof{figure}{\label{org8c8a810}
Concatenación}
...
\end{verbatim}
\captionof{figure}{\label{org9ba60cb}
Valor Muy Grande}
...
\end{verbatim}
\captionof{figure}{\label{org08076c5}
Valor Casteado}
...
\end{verbatim}
\captionof{figure}{\label{org53ea498}
Unarios}
...
\end{verbatim}
\captionof{figure}{\label{org41cdc8f}
...
\end{verbatim}
\captionof{figure}{\label{org3bf5131}
Comparación}
...
\end{verbatim}
\captionof{figure}{\label{org851cb7b}
...
\end{verbatim}
\captionof{figure}{\label{orgf8a456f}
Else-If}
...
\end{verbatim}
\captionof{figure}{\label{org9e74d0b}
Switch}
...
\end{verbatim}
\captionof{figure}{\label{orgcde9207}
Switch2}
...
\end{verbatim}
\captionof{figure}{\label{orgef39020}
Bucle While}
\subsection{El bucle for}
\label{sec:org16cb8be}
\label{org9df7326}
...
\end{verbatim}
\captionof{figure}{\label{org6e3f51b}
Bucle For}
...
\end{verbatim}
\captionof{figure}{\label{org9366eeb}
...
\end{verbatim}
\captionof{figure}{\label{org483dbb0}
...
\end{verbatim}
\captionof{figure}{\label{org154150e}
...
\end{verbatim}
\captionof{figure}{\label{org4701995}
Bucle do-while}
...
\label{sec:org6f97b21}
Inevitablemente se producirán errores en nuestro código, es un hecho, muchas veces estos errores serán \emph{en tiempo de compilación}, es decir, se producirán al tratar de compilar el código, aquí encontraremos errores de sintaxis, errores de tipos incompatibles (como el visto en el ejercicio \hyperref[org129ab57]{Valor Muy Grande}) y cosas así, sin embargo, hay otro tipo de errores llamados de \emph{tiempo de ejecución} que solo detectaremos una vez se esté ejecutando este código, estos errores producirán que nuestro programa termine su ejecución inesperadamente y no cumpla su función, estos errores inesperados se llaman \textbf{Excepciones}.
...
\end{verbatim}
\captionof{figure}{\label{orga714dc1}
Excepciones}
...
\end{verbatim}
\captionof{figure}{\label{org2f76e5f}
Try-Catch}
...
\end{verbatim}
\captionof{figure}{\label{org425e261}
...
\end{verbatim}
\captionof{figure}{\label{org812a4ed}
Mi primer método}
...
\end{verbatim}
\captionof{figure}{\label{org975d821}
Paso de valor}
...
\end{verbatim}
\captionof{figure}{\label{orgcfd3c8a}
Retorno de valor}
...
\end{verbatim}
\captionof{figure}{\label{org6c6aa49}
Cambio de objeto}
...
\end{verbatim}
\captionof{figure}{\label{org61e9e3e}
Cambio de propiedad}
...
\end{verbatim}
\captionof{figure}{\label{orgca7781f}
...
\end{verbatim}
\captionof{figure}{\label{orgfb9319a}
Valor null}
...
\end{verbatim}
\captionof{figure}{\label{orgf9ceb78}
Acceso a variable}
...
\end{verbatim}
\captionof{figure}{\label{orgce7acc1}
...
\end{verbatim}
\captionof{figure}{\label{orga5f82e9}
...
\end{verbatim}
\captionof{figure}{\label{orgf1852c9}
