...
\end{verbatim}
\captionof{figure}{\label{org00c6c55}
Hola Mundo}
...
\end{verbatim}
\captionof{figure}{\label{org0c1046e}
Aritmeticos}
...
\end{verbatim}
\captionof{figure}{\label{orgc211b74}
Concatenación}
...
\end{verbatim}
\captionof{figure}{\label{org7146de3}
Valor Muy Grande}
...
\end{verbatim}
\captionof{figure}{\label{org4651245}
Valor Casteado}
...
\end{verbatim}
\captionof{figure}{\label{org31085a0}
Unarios}
...
\end{verbatim}
\captionof{figure}{\label{org9ca2348}
...
\end{verbatim}
\captionof{figure}{\label{org53b6a3c}
Comparación}
...
\end{verbatim}
\captionof{figure}{\label{orga241618}
...
\end{verbatim}
\captionof{figure}{\label{org4a93e03}
Else-If}
...
\end{verbatim}
\captionof{figure}{\label{orga2a5c9f}
Switch}
...
\end{verbatim}
\captionof{figure}{\label{org0f4b11f}
Switch2}
...
\end{verbatim}
\captionof{figure}{\label{orga3047a3}
Bucle While}
\subsection{El bucle for}
\label{sec:org9c945d3}
\label{orga6ac4ee}
...
\end{verbatim}
\captionof{figure}{\label{org920934b}
Bucle For}
...
\end{verbatim}
\captionof{figure}{\label{org2ba3bde}
...
\end{verbatim}
\captionof{figure}{\label{org8426d47}
...
\end{verbatim}
\captionof{figure}{\label{org6c89737}
...
\end{verbatim}
\captionof{figure}{\label{orgfd0d813}
Bucle do-while}
...
\label{sec:org4adb45c}
Inevitablemente se producirán errores en nuestro código, es un hecho, muchas veces estos errores serán \emph{en tiempo de compilación}, es decir, se producirán al tratar de compilar el código, aquí encontraremos errores de sintaxis, errores de tipos incompatibles (como el visto en el ejercicio \hyperref[orga52661c]{Valor Muy Grande}) y cosas así, sin embargo, hay otro tipo de errores llamados de \emph{tiempo de ejecución} que solo detectaremos una vez se esté ejecutando este código, estos errores producirán que nuestro programa termine su ejecución inesperadamente y no cumpla su función, estos errores inesperados se llaman \textbf{Excepciones}.
...
\end{verbatim}
\captionof{figure}{\label{orgbef48af}
Excepciones}
...
\end{verbatim}
\captionof{figure}{\label{org63d1c94}
Try-Catch}
...
\end{verbatim}
\captionof{figure}{\label{org4fc15c1}
...
\end{verbatim}
\captionof{figure}{\label{org10e7d92}
Mi primer método}
...
\end{verbatim}
\captionof{figure}{\label{org611b549}
Paso de valor}
...
\end{verbatim}
\captionof{figure}{\label{org98169b7}
Retorno de valor}
...
\end{verbatim}
\captionof{figure}{\label{orga5e087c}
Cambio de objeto}
...
\end{verbatim}
\captionof{figure}{\label{orgdf4ba3a}
Cambio de propiedad}
...
\end{verbatim}
\captionof{figure}{\label{orgce5a3b8}
...
\end{verbatim}
\captionof{figure}{\label{orgc6c853e}
Valor null}
...
\label{sec:org04d367d}
\subsubsection{La clase Object}
\label{sec:orgc246f68}
...
Para insertar o recoger los valores de la lista lo haremos llamando a la variable como hacíamos habitualmente y añadiendo un número entre corchetes, como vimos en el ejercicio \hyperref[org9d2c852]{TryCatchMultipleFinally}, en ese ejercicio intentábamos obtener el primer valor (índice 0) de la variable \texttt{objeto} y lo hacíamos de la siguiente manera:
...
\end{verbatim}
\captionof{figure}{\label{orgcc73526}
Acceso a variable}
...
\end{verbatim}
\captionof{figure}{\label{orgb967692}
...
\end{verbatim}
\captionof{figure}{\label{org5a4c26d}
...
\end{verbatim}
\captionof{figure}{\label{org593d174}
...
\end{verbatim}
\captionof{figure}{\label{org79ebe14}
Herencia}
...
\end{verbatim}
\captionof{figure}{\label{org68bc6af}
