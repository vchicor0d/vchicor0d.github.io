...
\end{verbatim}
\captionof{figure}{\label{orgeb5d93d}
Hola Mundo}
...
\end{verbatim}
\captionof{figure}{\label{org939da5d}
Aritmeticos}
...
\end{verbatim}
\captionof{figure}{\label{org74e6eb3}
Concatenación}
...
\end{verbatim}
\captionof{figure}{\label{orgbd6fa61}
Unarios}
...
\end{verbatim}
\captionof{figure}{\label{org6a5dd3d}
...
\end{verbatim}
\captionof{figure}{\label{org92bb83a}
Comparación}
...
\end{verbatim}
\captionof{figure}{\label{org6b2b90d}
...
\end{verbatim}
\captionof{figure}{\label{org8929eac}
Else-If}
...
\end{verbatim}
\captionof{figure}{\label{org5a61333}
Switch}
...
\end{verbatim}
\captionof{figure}{\label{orgec2bbec}
Switch2}
...
\end{verbatim}
\captionof{figure}{\label{org1b74001}
Bucle While}
\subsection{El bucle for}
\label{sec:orgcfac0a3}
...
\end{verbatim}
\captionof{figure}{\label{org37413ff}
Bucle For}
...
\end{verbatim}
\captionof{figure}{\label{org3c18753}
...
\end{verbatim}
\captionof{figure}{\label{org722b69f}
...
\end{verbatim}
\captionof{figure}{\label{org23fb128}
Bucle do-while}
...
\end{verbatim}
\captionof{figure}{\label{org85140a0}
Mi primer método}
...
\end{verbatim}
\captionof{figure}{\label{orgc7ff764}
Paso de valor}
...
\end{verbatim}
\captionof{figure}{\label{org81817ce}
Retorno de valor}
...
\end{verbatim}
\captionof{figure}{\label{orge6cd76f}
Cambio de objeto}
...
\end{verbatim}
\captionof{figure}{\label{orgdcce2e2}
Cambio de propiedad}
