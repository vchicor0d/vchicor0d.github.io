...
\end{verbatim}
\captionof{figure}{\label{org875eb54}
Hola Mundo}
...
\end{verbatim}
\captionof{figure}{\label{orgd8e62ee}
Aritmeticos}
...
\end{verbatim}
\captionof{figure}{\label{org5046d47}
Concatenación}
...
\end{verbatim}
\captionof{figure}{\label{org58e1e61}
Valor Muy Grande}
...
\end{verbatim}
\captionof{figure}{\label{org0d2f487}
Valor Casteado}
...
\end{verbatim}
\captionof{figure}{\label{org2cd5f81}
Unarios}
...
\end{verbatim}
\captionof{figure}{\label{org18143d4}
...
\end{verbatim}
\captionof{figure}{\label{orge1ce6c5}
Comparación}
...
\end{verbatim}
\captionof{figure}{\label{org94dc8f6}
...
\end{verbatim}
\captionof{figure}{\label{org14b6eed}
Else-If}
...
\end{verbatim}
\captionof{figure}{\label{org3ce4b49}
Switch}
...
\end{verbatim}
\captionof{figure}{\label{orgfb401ed}
Switch2}
...
\end{verbatim}
\captionof{figure}{\label{orge3db381}
Bucle While}
\subsection{El bucle for}
\label{sec:orgbd82b80}
\label{orgbf49c05}
...
\end{verbatim}
\captionof{figure}{\label{org8a58759}
Bucle For}
...
\end{verbatim}
\captionof{figure}{\label{org6fd0554}
...
\end{verbatim}
\captionof{figure}{\label{org636f261}
...
\end{verbatim}
\captionof{figure}{\label{org4ac62f3}
...
\end{verbatim}
\captionof{figure}{\label{org7089306}
Bucle do-while}
...
\label{sec:orgdd9c3e0}
Inevitablemente se producirán errores en nuestro código, es un hecho, muchas veces estos errores serán \emph{en tiempo de compilación}, es decir, se producirán al tratar de compilar el código, aquí encontraremos errores de sintaxis, errores de tipos incompatibles (como el visto en el ejercicio \hyperref[org590f252]{Valor Muy Grande}) y cosas así, sin embargo, hay otro tipo de errores llamados de \emph{tiempo de ejecución} que solo detectaremos una vez se esté ejecutando este código, estos errores producirán que nuestro programa termine su ejecución inesperadamente y no cumpla su función, estos errores inesperados se llaman \textbf{Excepciones}.
...
\end{verbatim}
\captionof{figure}{\label{org57f9f0c}
Excepciones}
...
\end{verbatim}
\captionof{figure}{\label{orgbd73336}
Try-Catch}
...
\end{verbatim}
\captionof{figure}{\label{org7946440}
...
\end{verbatim}
\captionof{figure}{\label{org63257a9}
Mi primer método}
...
\end{verbatim}
\captionof{figure}{\label{orgafabbde}
Paso de valor}
...
\end{verbatim}
\captionof{figure}{\label{org68b35fa}
Retorno de valor}
...
\end{verbatim}
\captionof{figure}{\label{org6d581ef}
Cambio de objeto}
...
\end{verbatim}
\captionof{figure}{\label{org779885f}
Cambio de propiedad}
...
\end{verbatim}
\captionof{figure}{\label{org52e0e8a}
...
\end{verbatim}
\captionof{figure}{\label{orga97aab6}
Valor null}
...
\label{sec:org552059d}
\subsubsection{La clase Object}
\label{sec:orgabb74ad}
...
Para insertar o recoger los valores de la lista lo haremos llamando a la variable como hacíamos habitualmente y añadiendo un número entre corchetes, como vimos en el ejercicio \hyperref[orgde26cb6]{TryCatchMultipleFinally}, en ese ejercicio intentábamos obtener el primer valor (índice 0) de la variable \texttt{objeto} y lo hacíamos de la siguiente manera:
...
\end{verbatim}
\captionof{figure}{\label{org7f14fc5}
Acceso a variable}
...
\end{verbatim}
\captionof{figure}{\label{orga5a9c51}
...
\end{verbatim}
\captionof{figure}{\label{org0d92be2}
Constructor Date con fecha actual}

\begin{verbatim}
Thu May 28 14:38:30 CEST 2020
\end{verbatim}
...
\end{verbatim}
\captionof{figure}{\label{orga9cda2a}
...
\label{sec:orgcd5a3a2}
\subsubsection{System}
\label{sec:orgd9cbfdb}
\section{Herencia}
\label{sec:org14c81b9}
\subsection{Interfaces}
\label{sec:org8a5ad99}
\subsection{Clases abstractas}
\label{sec:org1cf1be8}
\end{document}
