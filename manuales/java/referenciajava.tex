...
\end{verbatim}
\captionof{figure}{\label{org3b48ed6}
Hola Mundo}
...
\end{verbatim}
\captionof{figure}{\label{org8d45197}
Aritmeticos}
...
\end{verbatim}
\captionof{figure}{\label{org50fe373}
Concatenación}
...
\end{verbatim}
\captionof{figure}{\label{org3487be4}
Valor Muy Grande}
...
\end{verbatim}
\captionof{figure}{\label{orga49695e}
Valor Casteado}
...
\end{verbatim}
\captionof{figure}{\label{org417f689}
Unarios}
...
\end{verbatim}
\captionof{figure}{\label{orge1815da}
...
\end{verbatim}
\captionof{figure}{\label{org037a552}
Comparación}
...
\end{verbatim}
\captionof{figure}{\label{orgaf29f71}
...
\end{verbatim}
\captionof{figure}{\label{org1bc7908}
Else-If}
...
\end{verbatim}
\captionof{figure}{\label{orga70c89d}
Switch}
...
\end{verbatim}
\captionof{figure}{\label{org9c66259}
Switch2}
...
\end{verbatim}
\captionof{figure}{\label{org4696f10}
Bucle While}
\subsection{El bucle for}
\label{sec:org7e3accc}
\label{orgdc05bcc}
...
\end{verbatim}
\captionof{figure}{\label{org53e1640}
Bucle For}
...
\end{verbatim}
\captionof{figure}{\label{org1ed6287}
...
\end{verbatim}
\captionof{figure}{\label{org05a1554}
...
\end{verbatim}
\captionof{figure}{\label{org869d78a}
...
\end{verbatim}
\captionof{figure}{\label{orge2821f3}
Bucle do-while}
...
\label{sec:org8c34365}
Inevitablemente se producirán errores en nuestro código, es un hecho, muchas veces estos errores serán \emph{en tiempo de compilación}, es decir, se producirán al tratar de compilar el código, aquí encontraremos errores de sintaxis, errores de tipos incompatibles (como el visto en el ejercicio \hyperref[org38ef72a]{Valor Muy Grande}) y cosas así, sin embargo, hay otro tipo de errores llamados de \emph{tiempo de ejecución} que solo detectaremos una vez se esté ejecutando este código, estos errores producirán que nuestro programa termine su ejecución inesperadamente y no cumpla su función, estos errores inesperados se llaman \textbf{Excepciones}.
...
\end{verbatim}
\captionof{figure}{\label{orge7f732d}
Excepciones}
...
\end{verbatim}
\captionof{figure}{\label{orgf65bca4}
Try-Catch}
...
\end{verbatim}
\captionof{figure}{\label{orgf406fa0}
...
\end{verbatim}
\captionof{figure}{\label{org01d55a0}
Mi primer método}
...
\end{verbatim}
\captionof{figure}{\label{orge316c93}
Paso de valor}
...
\end{verbatim}
\captionof{figure}{\label{org17dd952}
Retorno de valor}
...
\end{verbatim}
\captionof{figure}{\label{org8e49b36}
Cambio de objeto}
...
\end{verbatim}
\captionof{figure}{\label{org216577c}
Cambio de propiedad}
...
\end{verbatim}
\captionof{figure}{\label{org0cefad1}
...
\end{verbatim}
\captionof{figure}{\label{org912bce6}
Valor null}
...
\label{sec:org4bc1b9b}
\subsubsection{La clase Object}
\label{sec:org4c58246}
...
Para insertar o recoger los valores de la lista lo haremos llamando a la variable como hacíamos habitualmente y añadiendo un número entre corchetes, como vimos en el ejercicio \hyperref[org6ab08b5]{TryCatchMultipleFinally}, en ese ejercicio intentábamos obtener el primer valor (índice 0) de la variable \texttt{objeto} y lo hacíamos de la siguiente manera:
...
\end{verbatim}
\captionof{figure}{\label{org3b76cfe}
Acceso a variable}
...
\end{verbatim}
\captionof{figure}{\label{org1142193}
...
\end{verbatim}
\captionof{figure}{\label{org13a984e}
...
\end{verbatim}
\captionof{figure}{\label{orga36ba4c}
...
\end{verbatim}
\captionof{figure}{\label{org7128005}
Herencia}
...
\end{verbatim}
\captionof{figure}{Interfaz Animal}
...
\end{verbatim}
\captionof{figure}{Clase Tiburon}
...
\end{verbatim}
\captionof{figure}{\label{org675a78f}
Implementaciones de la interfaz Animal}
