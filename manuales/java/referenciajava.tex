...
\end{verbatim}
\captionof{figure}{\label{org5b133a2}
Hola Mundo}
...
\end{verbatim}
\captionof{figure}{\label{orgc204174}
Aritmeticos}
...
\end{verbatim}
\captionof{figure}{\label{org19f27e5}
Concatenación}
...
\end{verbatim}
\captionof{figure}{\label{orge8c8af8}
Unarios}
...
\end{verbatim}
\captionof{figure}{\label{orgb002877}
...
\end{verbatim}
\captionof{figure}{\label{org56e26fb}
Comparación}
...
\end{verbatim}
\captionof{figure}{\label{org6f00e0c}
...
\end{verbatim}
\captionof{figure}{\label{orgf61e419}
Else-If}
...
\end{verbatim}
\captionof{figure}{\label{org49ed85c}
Switch}
...
\end{verbatim}
\captionof{figure}{\label{org3faad7b}
Switch2}
...
\begin{center}
\includegraphics[width=.9\linewidth]{whileloop.png}
\end{center}
...
\end{verbatim}
\captionof{figure}{\label{org4eefdf4}
Bucle While}
...
\end{verbatim}
\captionof{figure}{\label{orgad31e40}
Bucle For}
...
\end{verbatim}
\captionof{figure}{\label{orga4cda71}
...
\section{Métodos}
\label{sec:org9352243}
\section{Objetos}
\label{sec:org5275f81}
\end{document}