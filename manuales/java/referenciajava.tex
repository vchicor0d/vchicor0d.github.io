...
\end{verbatim}
\captionof{figure}{\label{org44fb85b}
Hola Mundo}
...
\end{verbatim}
\captionof{figure}{\label{orgac3b12a}
Aritmeticos}
...
\end{verbatim}
\captionof{figure}{\label{org9ff8252}
Concatenación}
...
\end{verbatim}
\captionof{figure}{\label{org5ae913f}
Valor Muy Grande}
...
\end{verbatim}
\captionof{figure}{\label{org657b0de}
Valor Casteado}
...
\end{verbatim}
\captionof{figure}{\label{orgb37bd8a}
Unarios}
...
\end{verbatim}
\captionof{figure}{\label{orgbfd4073}
...
\end{verbatim}
\captionof{figure}{\label{orgb8d269c}
Comparación}
...
\end{verbatim}
\captionof{figure}{\label{orgecdb59c}
...
\end{verbatim}
\captionof{figure}{\label{org7b67dce}
Else-If}
...
\end{verbatim}
\captionof{figure}{\label{orgdd5fbf4}
Switch}
...
\end{verbatim}
\captionof{figure}{\label{org6398e62}
Switch2}
...
\end{verbatim}
\captionof{figure}{\label{org1a41096}
Bucle While}
\subsection{El bucle for}
\label{sec:org5adcc32}
...
\end{verbatim}
\captionof{figure}{\label{org088808b}
Bucle For}
...
\end{verbatim}
\captionof{figure}{\label{org555e404}
...
\end{verbatim}
\captionof{figure}{\label{org1a434cb}
...
\end{verbatim}
\captionof{figure}{\label{orge3b5f14}
Bucle do-while}
...
\label{sec:org38755f8}
Inevitablemente se producirán errores en nuestro código, es un hecho, muchas veces estos errores serán \emph{en tiempo de compilación}, es decir, se producirán al tratar de compilar el código, aquí encontraremos errores de sintaxis, errores de tipos incompatibles (como el visto en el ejercicio \hyperref[orgd3196f0]{Valor Muy Grande}) y cosas así, sin embargo, hay otro tipo de errores llamados de \emph{tiempo de ejecución} que solo detectaremos una vez se esté ejecutando este código, estos errores producirán que nuestro programa termine su ejecución inesperadamente y no cumpla su función, estos errores inesperados se llaman \textbf{Excepciones}.
...
\end{verbatim}
\captionof{figure}{\label{org8d58f35}
Excepciones}
...
\end{verbatim}
\captionof{figure}{\label{orgb8e911d}
Try-Catch}
...
\end{verbatim}
\captionof{figure}{\label{org14550b8}
...
\end{verbatim}
\captionof{figure}{\label{org74a9280}
Mi primer método}
...
\end{verbatim}
\captionof{figure}{\label{org752f185}
Paso de valor}
...
\end{verbatim}
\captionof{figure}{\label{org0163502}
Retorno de valor}
...
\end{verbatim}
\captionof{figure}{\label{orga48dc0f}
Cambio de objeto}
...
\end{verbatim}
\captionof{figure}{\label{orgdf2ae85}
Cambio de propiedad}
...
\end{verbatim}
\captionof{figure}{\label{orgb7f95c1}
Valor null}
...
\label{sec:org19fa7ba}
\subsubsection{La clase Object}
\label{sec:org96bd61f}
...
Para insertar o recoger los valores de la lista lo haremos llamando a la variable como hacíamos habitualmente y añadiendo un número entre corchetes, como vimos en el ejercicio \hyperref[org12563c2]{TryCatchMultipleFinally}, en ese ejercicio intentábamos obtener el primer valor (índice 0) de la variable \texttt{objeto} y lo hacíamos de la siguiente manera:
...
\end{verbatim}
\captionof{figure}{\label{org685a1ee}
Acceso a variable}
...
\end{verbatim}
\captionof{figure}{\label{orge093e42}
