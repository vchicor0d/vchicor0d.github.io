...
\end{verbatim}
\captionof{figure}{\label{orgc5b08b8}
Hola Mundo}
...
\end{verbatim}
\captionof{figure}{\label{org25d2d7f}
Aritmeticos}
...
\end{verbatim}
\captionof{figure}{\label{orgcb45bc2}
Concatenación}
...
\end{verbatim}
\captionof{figure}{\label{orga671f9a}
Unarios}
...
\end{verbatim}
\captionof{figure}{\label{org73d46e0}
...
\end{verbatim}
\captionof{figure}{\label{orgbac1e00}
Comparación}
...
\end{verbatim}
\captionof{figure}{\label{orgff5db7f}
...
\end{verbatim}
\captionof{figure}{\label{orgbd688b2}
Else-If}
...
\end{verbatim}
\captionof{figure}{\label{org16a412a}
Switch}
...
\end{verbatim}
\captionof{figure}{\label{orgd8c9844}
Switch2}
...
\end{verbatim}
\captionof{figure}{\label{orgd268ad5}
Bucle While}
\subsection{El bucle for}
\label{sec:orgd0f9a85}
...
\end{verbatim}
\captionof{figure}{\label{org9346937}
Bucle For}
...
\end{verbatim}
\captionof{figure}{\label{orgdfa3a4d}
...
\end{verbatim}
\captionof{figure}{\label{org22e4377}
...
\end{verbatim}
\captionof{figure}{\label{org528d54c}
Bucle do-while}
...
\end{verbatim}
\captionof{figure}{\label{org20e0480}
Mi primer método}
