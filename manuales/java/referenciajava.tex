...
\end{verbatim}
\captionof{figure}{\label{org9328773}
Hola Mundo}
...
\end{verbatim}
\captionof{figure}{\label{orgd58afae}
Aritmeticos}
...
\end{verbatim}
\captionof{figure}{\label{org45a9558}
Concatenación}
...
\end{verbatim}
\captionof{figure}{\label{org55c86d6}
Valor Muy Grande}
...
\end{verbatim}
\captionof{figure}{\label{org4f66f44}
Valor Casteado}
...
\end{verbatim}
\captionof{figure}{\label{org979ec2d}
Unarios}
...
\end{verbatim}
\captionof{figure}{\label{orgea631f1}
...
\end{verbatim}
\captionof{figure}{\label{org87946b3}
Comparación}
...
\end{verbatim}
\captionof{figure}{\label{org0f49e2e}
...
\end{verbatim}
\captionof{figure}{\label{org07dbb03}
Else-If}
...
\end{verbatim}
\captionof{figure}{\label{org005bb5d}
Switch}
...
\end{verbatim}
\captionof{figure}{\label{org73ca444}
Switch2}
...
\end{verbatim}
\captionof{figure}{\label{org2b3c28c}
Bucle While}
\subsection{El bucle for}
\label{sec:org9ad9300}
\label{orge972ded}
...
\end{verbatim}
\captionof{figure}{\label{orgc6f543b}
Bucle For}
...
\end{verbatim}
\captionof{figure}{\label{org01ad5ba}
...
\end{verbatim}
\captionof{figure}{\label{org4f8667d}
...
\end{verbatim}
\captionof{figure}{\label{org65820fc}
...
\end{verbatim}
\captionof{figure}{\label{org38807db}
Bucle do-while}
...
\label{sec:org0ba310f}
Inevitablemente se producirán errores en nuestro código, es un hecho, muchas veces estos errores serán \emph{en tiempo de compilación}, es decir, se producirán al tratar de compilar el código, aquí encontraremos errores de sintaxis, errores de tipos incompatibles (como el visto en el ejercicio \hyperref[orgc62ee4d]{Valor Muy Grande}) y cosas así, sin embargo, hay otro tipo de errores llamados de \emph{tiempo de ejecución} que solo detectaremos una vez se esté ejecutando este código, estos errores producirán que nuestro programa termine su ejecución inesperadamente y no cumpla su función, estos errores inesperados se llaman \textbf{Excepciones}.
...
\end{verbatim}
\captionof{figure}{\label{org8eeec1d}
Excepciones}
...
\end{verbatim}
\captionof{figure}{\label{org0d56fdf}
Try-Catch}
...
\end{verbatim}
\captionof{figure}{\label{orgb55973c}
...
\end{verbatim}
\captionof{figure}{\label{org569fde1}
Mi primer método}
...
\end{verbatim}
\captionof{figure}{\label{org9786819}
Paso de valor}
...
\end{verbatim}
\captionof{figure}{\label{org0851d04}
Retorno de valor}
...
\end{verbatim}
\captionof{figure}{\label{orge80cf31}
Cambio de objeto}
...
\end{verbatim}
\captionof{figure}{\label{org8a629a3}
Cambio de propiedad}
...
\end{verbatim}
\captionof{figure}{\label{org2a1ea75}
...
\end{verbatim}
\captionof{figure}{\label{orgea1a2cf}
Valor null}
...
\label{sec:org108e5d5}
\subsubsection{La clase Object}
\label{sec:org4b47e76}
...
Para insertar o recoger los valores de la lista lo haremos llamando a la variable como hacíamos habitualmente y añadiendo un número entre corchetes, como vimos en el ejercicio \hyperref[org3a3854d]{TryCatchMultipleFinally}, en ese ejercicio intentábamos obtener el primer valor (índice 0) de la variable \texttt{objeto} y lo hacíamos de la siguiente manera:
...
\end{verbatim}
\captionof{figure}{\label{orga7e6768}
Acceso a variable}
...
\end{verbatim}
\captionof{figure}{\label{org1570630}
...
\subsubsection{Date}
\label{sec:orgacc6dc0}
La clase Date
\subsubsection{List y ArrayList}
\label{sec:orgfee78a8}
\subsubsection{System}
\label{sec:orgb8daac2}
\section{Herencia}
\label{sec:org36bbc74}
\subsection{Interfaces}
\label{sec:orga53ae12}
\subsection{Clases abstractas}
\label{sec:orgdcfcaad}
\end{document}
