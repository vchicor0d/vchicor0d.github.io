...
\end{verbatim}
\captionof{figure}{\label{orge8ee11f}
Hola Mundo}
...
\end{verbatim}
\captionof{figure}{\label{org07e1f47}
Aritmeticos}
...
\end{verbatim}
\captionof{figure}{\label{org919cdba}
Concatenación}
...
\end{verbatim}
\captionof{figure}{\label{org42baae7}
Valor Muy Grande}
...
\end{verbatim}
\captionof{figure}{\label{orgf7e060f}
Valor Casteado}
...
\end{verbatim}
\captionof{figure}{\label{orgad2aa1e}
Unarios}
...
\end{verbatim}
\captionof{figure}{\label{org7dc5a60}
...
\end{verbatim}
\captionof{figure}{\label{orgf0ce3cb}
Comparación}
...
\end{verbatim}
\captionof{figure}{\label{orgf981238}
...
\end{verbatim}
\captionof{figure}{\label{orgce93fdd}
Else-If}
...
\end{verbatim}
\captionof{figure}{\label{orgf22b450}
Switch}
...
\end{verbatim}
\captionof{figure}{\label{org9b703dd}
Switch2}
...
\end{verbatim}
\captionof{figure}{\label{org50e38f5}
Bucle While}
\subsection{El bucle for}
\label{sec:orgde819f0}
...
\end{verbatim}
\captionof{figure}{\label{orgd3e9551}
Bucle For}
...
\end{verbatim}
\captionof{figure}{\label{org5f0c3d5}
...
\end{verbatim}
\captionof{figure}{\label{org0067519}
...
\end{verbatim}
\captionof{figure}{\label{orgc15c105}
Bucle do-while}
...
\label{sec:org308412e}
Inevitablemente se producirán errores en nuestro código, es un hecho, muchas veces estos errores serán \emph{en tiempo de compilación}, es decir, se producirán al tratar de compilar el código, aquí encontraremos errores de sintaxis, errores de tipos incompatibles (como el visto en el ejercicio \hyperref[org987acb5]{Valor Muy Grande}) y cosas así, sin embargo, hay otro tipo de errores llamados de \emph{tiempo de ejecución} que solo detectaremos una vez se esté ejecutando este código, estos errores producirán que nuestro programa termine su ejecución inesperadamente y no cumpla su función, estos errores inesperados se llaman \textbf{Excepciones}.
...
\end{verbatim}
\captionof{figure}{\label{orge94e147}
Excepciones}
...
\end{verbatim}
\captionof{figure}{\label{org3b26cbe}
Try-Catch}
...
\end{verbatim}
\captionof{figure}{\label{org1877016}
...
\end{verbatim}
\captionof{figure}{\label{org1a97b71}
Mi primer método}
...
\end{verbatim}
\captionof{figure}{\label{orgcda00f9}
Paso de valor}
...
\end{verbatim}
\captionof{figure}{\label{orge715ea4}
Retorno de valor}
...
\end{verbatim}
\captionof{figure}{\label{org061e2b2}
Cambio de objeto}
...
\end{verbatim}
\captionof{figure}{\label{orgb590d7c}
Cambio de propiedad}
...
\end{verbatim}
\captionof{figure}{\label{orga8e6126}
Valor null}
...
\label{sec:orgd28193b}

\subsubsection{String}
\label{sec:orgd0d2a07}
