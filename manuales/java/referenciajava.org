...
#+Name: PasoDeValor
#+BEGIN_SRC java :export both :classname PasoDeValor
  class PasoDeValor {
...
#+Name: RetornoDeValor
#+BEGIN_SRC java :export both :classname RetornoDeValor
...
#+Name: CambioDeObjeto
#+BEGIN_SRC java :export both :classname CambioDeObjeto
